...
async def gerar_descricao(projeto: Projeto):
    prompt = f"""
    Gere uma descrição clara, atrativa e finalizada corretamente, com no máximo 500 caracteres, para um projeto que o contratate está postando com base nas informações abaixo:
